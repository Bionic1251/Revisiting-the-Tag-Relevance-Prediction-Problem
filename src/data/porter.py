...
class PorterStemmer(StemmerI): 
    ...
    def __init__(self):
        ...
        self.skipStem = metadata.MetaData().getNames(minCount=20)
    ...
    def stem_word(self, p, i=0, j=None):
        ...
        if self.b[self.k0:self.k+1] in self.pool:  # if self.pool.has_key(self.b[self.k0:self.k+1])
    ...
    def stem(self, word, adjustCase=True):
        if word in self.skipStem:
            return word
