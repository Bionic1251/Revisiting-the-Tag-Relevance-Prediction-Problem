...
from src.models.tagdl_utils_json import *
...
FPATH_DATA_SURVEY_LOCAL = get_path('data/processed/features_r.csv') # "./data/data_survey_with_target.csv"
...
TAGS_MAPPINGS_FILE_GENSIM = get_path('temp/tags_word2vec.json')
TAGS_MAPPINGS_FILE_ONE_HOT = get_path('temp/tags_one_hot.json')
...
def create_and_save_tags_one_hot_mappings():
    logger.info("Create one hot mappings")
    enc = OneHotEncoder()
    mapping = {}
